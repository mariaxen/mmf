...
from transformers.modeling_outputs import BaseModelOutput, ModelOutput #ImageClassifierOutput
...
from .doc import add_start_docstrings, add_start_docstrings_to_model_forward, replace_return_docstrings
